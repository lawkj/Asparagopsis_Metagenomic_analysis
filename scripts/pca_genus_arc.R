...
#PCA ALL archaea
# Read in your data
data16 <- read_excel("genusarc_normalizedm.xlsx")
...
ggsave("genusarc_pca_all_noellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("genusarc_pca_all_ellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("genusarc_pca_P1_noellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("genusarc_pca_P1_ellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("genusarc_pca_P2_noellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("genusarc_pca_P2_ellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("genusarc_pca_P3_noellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("genusarc_pca_P3_ellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("genusarc_pca_ASP_noellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("genusarc_pca_ASP_ellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("genusarc_pca_CNT_noellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("genusarc_pca_CNT_ellipse.png", width = 10, height = 8, dpi = 300)
