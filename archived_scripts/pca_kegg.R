...
#PCA ALL
# Read in your data
data16 <- read_excel("keggpathway_normalizedm.xlsx")
...
ggsave("keggpathway_pca_all_noellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("keggpathway_pca_all_ellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("keggpathway_pca_P1_noellipse.png", width = 10, height = 8, dpi = 300)

#P1keggpathwayellipse
# Plot with custom colors and shapes, using Med for legend
ggplot(pca_scores, aes(x = PC1, y = PC2)) +
    geom_point(aes(color = Med, shape = Med), size = 3, alpha = 0.7) +  # Plot points, keep Med for legend
    stat_ellipse(aes(group = Med, color = Med), linetype = "dashed", linewidth = 0.3, level = 0.68)+
...
ggsave("keggpathway_pca_P1_ellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("keggpathway_pca_P2_noellipse.png", width = 10, height = 8, dpi = 300)

#P2keggpathwayellipse
# Plot with custom colors and shapes, using Med for legend
ggplot(pca_scores, aes(x = PC1, y = PC2)) +
    geom_point(aes(color = Med, shape = Med), size = 3, alpha = 0.7) +  # Plot points, keep Med for legend
    stat_ellipse(aes(group = Med, color = Med), linetype = "dashed", linewidth = 0.3, level = 0.68)+
...
ggsave("keggpathway_pca_P2_ellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("keggpathway_pca_P3_noellipse.png", width = 10, height = 8, dpi = 300)

#P3keggpathwayellipse
# Plot with custom colors and shapes, using Med for legend
ggplot(pca_scores, aes(x = PC1, y = PC2)) +
    geom_point(aes(color = Med, shape = Med), size = 3, alpha = 0.7) +  # Plot points, keep Med for legend
    stat_ellipse(aes(group = Med, color = Med), linetype = "dashed", linewidth = 0.3, level = 0.68)+
...
ggsave("keggpathway_pca_P3_ellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("keggpathway_pca_ASP_noellipse.png", width = 10, height = 8, dpi = 300)

#ASPkeggpathwayellipse
# Plot with custom colors and shapes, using Med for legend
ggplot(pca_scores, aes(x = PC1, y = PC2)) +
    geom_point(aes(color = Med, shape = Med), size = 3, alpha = 0.7) +  # Plot points, keep Med for legend
    stat_ellipse(aes(group = Med, color = Med), linetype = "dashed", linewidth = 0.3, level = 0.68)+
...
ggsave("keggpathway_pca_ASP_ellipse.png", width = 10, height = 8, dpi = 300)
...
ggsave("keggpathway_pca_CNT_noellipse.png", width = 10, height = 8, dpi = 300)

#CNTkeggpathwayellipse
# Plot with custom colors and shapes, using Med for legend
ggplot(pca_scores, aes(x = PC1, y = PC2)) +
    geom_point(aes(color = Med, shape = Med), size = 3, alpha = 0.7) +  # Plot points, keep Med for legend
    stat_ellipse(aes(group = Med, color = Med), linetype = "dashed", linewidth = 0.3, level = 0.68)+
...
ggsave("keggpathway_pca_CNT_ellipse.png", width = 10, height = 8, dpi = 300)
